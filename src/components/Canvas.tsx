...
interface CanvasProps {
	...
	width: number;
	height: number;
	maxImageWidth?: number; // Prop opcional para el ancho máximo de la imagen
}
...
const Canvas: React.FC<CanvasProps> = ({
	...
	width,
	height,
	maxImageWidth // Prop opcional para el ancho máximo de la imagen
}) => {
	...
	return (
		<canvas ref={canvasRef} width={width} height={height} style={{ border: '1px solid white', marginBottom: '20px' }} />
	);
};
