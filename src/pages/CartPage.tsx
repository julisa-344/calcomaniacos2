...
function CartPage() {
	...
	const decrement = (index: number) => {
      ...
      // Crea una copia del carrito actual y elimina el producto en la posición 'index'
      const updatedCart = [...cart];
      updatedCart.splice(index, 1);
      setCart(updatedCart);

      // También reinicia el contador para ese producto si es necesario
        ...
        <div>
          ...
          <div className="flex justify-between">
            ...
            <p className="sub-title">
              ...
              {cart.reduce(
                (total, product, index) =>
                  total + product.price * (counts[index] || 1),
                0
              )}
            </p>
          </div>
